...
在struts-config.xml中加入一塊 global-exceptions 的區塊，

而在該區塊內，就能定義當出現某種特定的exception時,該由哪一個錯誤控制程式處理,

以及要導到哪一頁去。

這邊以java.lang.Exception為例，因為所有exception偕是繼承它而來，所以只要設定了這一項，
...
type指的就是這一個錯誤控制項目所要欄截處理的Exception，
